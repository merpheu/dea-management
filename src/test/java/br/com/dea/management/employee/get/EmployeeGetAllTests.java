...
public class EmployeeGetAllTests {
    ...
    void whenRequestingEmployeeList_thenReturnListOfEmployeePaginatedSuccessfully() throws Exception {
        ...
        mockMvc.perform(get("/employee?page=0&pageSize=4"))
                ...
                .andExpect(jsonPath("$.content[0].email", is("email@eu.com 0")))
                ...
                .andExpect(jsonPath("$.content[1].email", is("email@eu.com 1")))
                ...
                .andExpect(jsonPath("$.content[2].email", is("email@eu.com 10")))
                ...
                .andExpect(jsonPath("$.content[3].email", is("email@eu.com 11")))
